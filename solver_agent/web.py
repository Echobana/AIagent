      ...
      <form id='generator-form' method='post' action='/generate'>
        <details>
          ...
          <div style='padding-top:10px'>
            ...
            <label>API key (for cloud providers):</label><br>
            <input type='password' name='api_key' style='width:480px' placeholder='api key'/><br><br>

            <label>Base URL (optional, required for unknown custom providers):</label><br>
...
def generate(
    ...
    try:
        ...
        out_path = save_yaml(config, Path(filename or "generated_config.yaml"))
